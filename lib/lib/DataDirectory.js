...
var DataDirectory = function () {
    ...
    (0, _createClass3.default)(DataDirectory, [{
        ...
        value: function () {
            var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(type) {
        ...
        key: 'loadFile',
        value: function () {
            var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(type, name) {
                var text, content, id;
