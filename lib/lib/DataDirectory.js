...
var DataDirectory = function () {
    ...
    (0, _createClass3.default)(DataDirectory, [{
        ...
        key: 'store',
        value: function () {
            var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(type, id, jsonContent) {
                    ...
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            ...
                            case 7:
                                ...
                                return _context3.abrupt('return', _promise2.default.all(files.map(this.loadFile.bind(this, type))));
        ...
        key: 'loadFile',
        value: function () {
            var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(type, name) {
